...
for Participant_Num = 1:N_Participants
    ...
    if Participant_Num < 10
        ...
        cd(strcat(['2023_10_S' num2str(Participant_Num),'_POD1']))
    else
    ...
    Noise_Amplitude = 0.05*rand(1,1) + 0.005; %increasing noise increased variability
    ...
    if Participant_Num < 10
        writematrix(SLA', ...
            strcat(['2023_10_20_S0' num2str(Participant_Num),'_POD1_SLA.csv']))
    else
        writematrix(SLA', ...
            strcat(['2023_10_20_S' num2str(Participant_Num),'_POD2_SLA.csv']))
    end
    cd(Home)
end
%linkaxes(ax) This line of code aligns values for the plot's y-axis
