...
for Participant_Num = 1:N_Participants
    ...
    if Participant_Num < 10
        mkdir(strcat(['2023_10_20_S{Participant_Num}_POD1' num2str(Participant_Num)]))
        cd(strcat(['2023_10_20_S{Participant_Num}_POD1' num2str(Participant_Num)]))
    else
        mkdir(strcat(['2023_10_20_S{Participant_Num}_POD2' num2str(Participant_Num)]))
        cd(strcat(['2023_10_20_S{Participant_Num}_POD2' num2str(Participant_Num)]))
    end
    ...
    Noise_Amplitude = 0.06*rand(1,1) + 0.008;
    ...
    if Participant_Num < 10
        writematrix(SLA', ...
            strcat(['2023_10_20_S{Participant_Num}_POD1' num2str(Participant_Num) '_SLA.csv']))
    else
        writematrix(SLA', ...
            strcat(['2023_10_20_S{Participant_Num}_POD2' num2str(Participant_Num) '_SLA.csv']))
    end
    cd(Home)
end
linkaxes(ax) %this is the line that aligns the y-axis across plots
